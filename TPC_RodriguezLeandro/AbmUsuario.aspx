...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Button Style="margin-top: 15px; margin-left:25px; margin-bottom: 15px" Class="btn btn-primary" ID="btnAltausuario" Text="Agregar usuario" runat="server" OnClick="btnAltausuario_Click" />
